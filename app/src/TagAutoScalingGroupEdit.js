...
class TagAutoScalingGroupEdit extends Component {
  ...
  async handleSubmit(event) {
    ...
    const hist= FRT_BASE_URL + '/autoscalinggroup/' + item.autoScalingGroup.id +'/tags'; 
  ...
  render() {
    ...
    const canc = FRT_BASE_URL + "/autoscalinggroup/" + item.autoScalingGroup.id + "/tags";
...
export default withRouter(TagAutoScalingGroupEdit);